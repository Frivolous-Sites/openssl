...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_mlkem512), "mlkem512"},
    {OQS_KEM_CURVEID(NID_mlkem768), "mlkem768"},
    {OQS_KEM_CURVEID(NID_mlkem1024), "mlkem1024"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_p256_mlkem512), "p256 - mlkem512 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_mlkem768), "p384 - mlkem768 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_mlkem1024), "p521 - mlkem1024 hybrid"},
...
///// OQS_TEMPLATE_FRAGMENT_POPULATE_SIGALG_TBL_START
    ...
    {TLSEXT_SIGALG_p256_mldsa44, "p256_mldsa44"},
    {TLSEXT_SIGALG_rsa3072_mldsa44, "rsa3072_mldsa44"},
    {TLSEXT_SIGALG_mldsa65, "mldsa65"},
    {TLSEXT_SIGALG_p384_mldsa65, "p384_mldsa65"},
    {TLSEXT_SIGALG_mldsa87, "mldsa87"},
    {TLSEXT_SIGALG_p521_mldsa87, "p521_mldsa87"},
    ...
    {TLSEXT_SIGALG_falconpadded512, "falconpadded512"},
    {TLSEXT_SIGALG_p256_falconpadded512, "p256_falconpadded512"},
    {TLSEXT_SIGALG_rsa3072_falconpadded512, "rsa3072_falconpadded512"},
    {TLSEXT_SIGALG_falcon1024, "falcon1024"},
    {TLSEXT_SIGALG_p521_falcon1024, "p521_falcon1024"},
    {TLSEXT_SIGALG_falconpadded1024, "falconpadded1024"},
    {TLSEXT_SIGALG_p521_falconpadded1024, "p521_falconpadded1024"},
