...
#amended by Michael Baentsch and Frivolous-Sites
...
# upstream tag (1.1.1u in this case):
QUIC_OPENSSL_TAG=OpenSSL_1_1_1u+quic
...
git clone https://github.com/Frivolous-Sites/openssl.git oqs-openssl-quic
