...
///// OQS_TEMPLATE_FRAGMENT_LIST_SIG_SWITCH_CASES_START
    ...
    case EVP_PKEY_P256_FALCONPADDED512:
    case EVP_PKEY_RSA3072_FALCONPADDED512:
    case EVP_PKEY_FALCON1024:
    case EVP_PKEY_P521_FALCON1024:
    case EVP_PKEY_FALCONPADDED1024:
    case EVP_PKEY_P521_FALCONPADDED1024:
    ...
    case EVP_PKEY_MAYO1:
    case EVP_PKEY_P256_MAYO1:
    case EVP_PKEY_MAYO2:
    case EVP_PKEY_P256_MAYO2:
    case EVP_PKEY_MAYO3:
